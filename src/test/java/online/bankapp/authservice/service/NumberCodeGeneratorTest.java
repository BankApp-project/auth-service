...
import online.bankapp.authservice.service.impl.NumberCodeGenerator;
...
class NumberCodeGeneratorTest {
    ...
    void testGenerateZeroLength() {
        ...
        OTPGeneratorException exception = assertThrows(OTPGeneratorException.class, () -> codeGenerator.generate(0));
    ...
    void testGenerateNegativeLength() {
        ...
        OTPGeneratorException exception = assertThrows(OTPGeneratorException.class, () -> codeGenerator.generate(-1));
        assertEquals("PIN length must be greater than 0", exception.getMessage());
    }
    ...
    void testGenerateExceedingMaxLength() {
        ...
        OTPGeneratorException exception = assertThrows(OTPGeneratorException.class, () -> codeGenerator.generate(10));
